------------------------------------------------------------------------------------------
-- Daniel's Hyprland Config                                                             --
-- https://github.com/DanielPiliutsin/dynamic-hue                                       --
-- https://danielpiliutsin.github.io                                                    --
------------------------------------------------------------------------------------------
...
hl.workspace_rule({workspace = "998", monitor = "DP-3", default = true})
...
hl.on("hyprland.start", function ()
    ...
    hl.exec_cmd("swaync & hypridle & udiskie")                               -- Load System Utilities
    hl.exec_cmd("waybar & awww-daemon & ~/.config/hypr/scripts/hue.sh -r") -- Load System Customization
 end)
...
hl.env("XGD_SESSION_TYPE", "wayland")
...
hl.bind(mainMod .. " + right", hl.dsp.exec_cmd("bash $HOME/.config/hypr/scripts/hue.sh -n"))
